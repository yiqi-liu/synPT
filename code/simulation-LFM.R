...
for (iter in 1:num_MC){
  ...
  start <- Sys.time()
  ### START: DGP-SDID1 treated unit is one state, SDID is satisfied ----
  ...
  result_pt <- bind_rows(
    result_pt,
    c(as.list(tau_pt), list(type = "est", DGP = "SDID1", niter=iter)),
    c(as.list(se_pt), list(type = "se", DGP = "SDID1", niter=iter)),
    c(as.list(coverage_pt), list(type = "coverage", DGP = "SDID1", niter=iter)),
    c(as.list(time_elapsed_pt), list(type = "time", DGP = "SDID1", niter=iter)),
    c(as.list(diff_in_means), list(type = "est_dim", DGP = "SDID1", niter=iter)),
    c(as.list(se_diff_in_means), list(type = "se_dim", DGP = "SDID1", niter=iter)),
    c(as.list(cov_diff_in_means), list(type = "coverage_dim", DGP = "SDID1", niter=iter))
  )
  ## END: PT-DID ------------------------------------
  ...
  result_sdid <- bind_rows(
    result_sdid,
    list("2018" = tau_sdid, type = "est", DGP = "SDID1", niter=iter),
    list("2018" = se_sdid, type = "se", DGP = "SDID1", niter=iter),
    list("2018" = coverage_sdid, type = "coverage", DGP = "SDID1", niter=iter),
    list("2018" = time_elapsed_sdid, type = "time", DGP = "SDID1", niter=iter)
  )
  ## END: SDID --------------------------------------
  ...
  result_sc <- bind_rows(
    result_sc,
    list("2018" = tau_sc, type = "est", DGP = "SDID1", niter=iter),
    list("2018" = se_sc, type = "se", DGP = "SDID1", niter=iter),
    list("2018" = coverage_sc, type = "coverage", DGP = "SDID1", niter=iter),
    list("2018" = time_elapsed_sc, type = "time", DGP = "SDID1", niter=iter)
  )
  ## END: SC --------------------------------------
  ...
  result_spt <- bind_rows(
    result_spt,
    list("2018" = min(cs_tau), type = "cs_lb", DGP = "SDID1", niter=iter),
    list("2018" = max(cs_tau), type = "cs_ub", DGP = "SDID1", niter=iter),
    list("2018" = as.numeric(true_tau <= max(cs_tau) & true_tau >= min(cs_tau)), type = "coverage", DGP = "SDID1", niter=iter),
    list("2018" = time_elapsed_spt, type = "time", DGP = "SDID1", niter=iter)
  )
  frac_rej_SDID <- append(frac_rej_SDID, 1-length(cs_tau)/500)
  ## END: SPT ------------------------------------
  ### END: DGP-SDID1 treated unit is one state, SDID is satisfied ----
  
  
  
  ## START: DGP-noSDID1 treated unit is one state, non-sparse weight ----
  ...
  result_pt <- bind_rows(
    result_pt,
    c(as.list(tau_pt), list(type = "est", DGP = "noSDID1", niter=iter)),
    c(as.list(se_pt), list(type = "se", DGP = "noSDID1", niter=iter)),
    c(as.list(coverage_pt), list(type = "coverage", DGP = "noSDID1", niter=iter)),
    c(as.list(time_elapsed_pt), list(type = "time", DGP = "noSDID1", niter=iter)),
    c(as.list(diff_in_means), list(type = "est_dim", DGP = "noSDID1", niter=iter)),
    c(as.list(se_diff_in_means), list(type = "se_dim", DGP = "noSDID1", niter=iter)),
    c(as.list(cov_diff_in_means), list(type = "coverage_dim", DGP = "noSDID1", niter=iter))
  )
  ## END: PT-DID ------------------------------------
  ...
  result_sdid <- bind_rows(
    result_sdid,
    list("2018" = tau_sdid, type = "est", DGP = "noSDID1", niter=iter),
    list("2018" = se_sdid, type = "se", DGP = "noSDID1", niter=iter),
    list("2018" = coverage_sdid, type = "coverage", DGP = "noSDID1", niter=iter),
    list("2018" = time_elapsed_sdid, type = "time", DGP = "noSDID1", niter=iter)
  )
  ## END: SDID --------------------------------------
  ...
  result_sc <- bind_rows(
    result_sc,
    list("2018" = tau_sc, type = "est", DGP = "noSDID1", niter=iter),
    list("2018" = se_sc, type = "se", DGP = "noSDID1", niter=iter),
    list("2018" = coverage_sc, type = "coverage", DGP = "noSDID1", niter=iter),
    list("2018" = time_elapsed_sc, type = "time", DGP = "noSDID1", niter=iter)
  )
  ## END: SC --------------------------------------
  ...
  result_spt <- bind_rows(
    result_spt,
    list("2018" = min(cs_tau), type = "cs_lb", DGP = "noSDID1", niter=iter),
    list("2018" = max(cs_tau), type = "cs_ub", DGP = "noSDID1", niter=iter),
    list("2018" = as.numeric(true_tau <= max(cs_tau) & true_tau >= min(cs_tau)), type = "coverage", DGP = "noSDID1", niter=iter),
    list("2018" = time_elapsed_spt, type = "time", DGP = "noSDID1", niter=iter)
  )
  frac_rej_noSDID <- append(frac_rej_noSDID, 1-length(cs_tau)/500)
  ## END: SPT ------------------------------------
  
  
  ### END: DGP-noSDID1 treated unit is one state, non-sparse weight ----
  
  end <- Sys.time()
  
  print(paste0("SDID1: ----------------------"))
  print(paste0("PT-DID avg bias: ", mean(abs(true_tau-subset(result_pt, type=="est" & DGP=="SDID1")$`2018`))))
  print(paste0("PT-DID avg bias (DiM): ", mean(abs(true_tau-subset(result_pt, type=="est_dim" & DGP=="SDID1")$`2018`))))
  print(paste0("PT-DID avg CI length: ", 1.96*2*mean(subset(result_pt, type=="se" & DGP=="SDID1")$`2018`)))
  print(paste0("PT-DID avg CI length (DiM): ", 1.96*2*mean(subset(result_pt, type=="se_dim" & DGP=="SDID1")$`2018`)))
  print(paste0("PT-DID coverage rate: ", mean(subset(result_pt, type=="coverage" & DGP=="SDID1")$`2018`)))
  print(paste0("PT-DID coverage rate (DiM): ", mean(subset(result_pt, type=="coverage_dim" & DGP=="SDID1")$`2018`)))
  print(paste0("PT-DID avg time: ", mean(subset(result_pt, type=="time" & DGP=="SDID1")$`2018`)))
  print(paste0("-"))
  print(paste0("SDID avg bias: ", mean(abs(true_tau-subset(result_sdid, type=="est" & DGP=="SDID1")$`2018`))))
  print(paste0("SDID avg CI length: ", 1.96*2*mean(subset(result_sdid, type=="se" & DGP=="SDID1")$`2018`)))
  print(paste0("SDID coverage rate: ", mean(subset(result_sdid, type=="coverage" & DGP=="SDID1")$`2018`)))
  print(paste0("SDID avg time: ", mean(subset(result_sdid, type=="time" & DGP=="SDID1")$`2018`)))
  print(paste0("-"))
  print(paste0("SC avg bias: ", mean(abs(true_tau-subset(result_sc, type=="est" & DGP=="SDID1")$`2018`))))
  print(paste0("SC avg CI length: ", 1.96*2*mean(subset(result_sc, type=="se" & DGP=="SDID1")$`2018`)))
  print(paste0("SC coverage rate: ", mean(subset(result_sc, type=="coverage" & DGP=="SDID1")$`2018`)))
  print(paste0("SC avg time: ", mean(subset(result_sc, type=="time" & DGP=="SDID1")$`2018`)))
  print(paste0("-"))
  print(paste0("SPT avg CS length: ", mean(subset(result_spt, type=="cs_ub" & DGP=="SDID1")$`2018`-subset(result_spt, type=="cs_lb" & DGP=="SDID1")$`2018`)))
  print(paste0("SPT coverage rate: ", mean(subset(result_spt, type=="coverage" & DGP=="SDID1")$`2018`)))
  print(paste0("SPT avg time: ", mean(subset(result_spt, type=="time" & DGP=="SDID1")$`2018`)))
  print(paste0("frac cand_tau rej: ", mean(frac_rej_SDID)))
  print(paste0("noSDID1: ----------------------"))
  print(paste0("PT-DID avg bias: ", mean(abs(true_tau-subset(result_pt, type=="est" & DGP=="noSDID1")$`2018`))))
  print(paste0("PT-DID avg bias (DiM): ", mean(abs(true_tau-subset(result_pt, type=="est_dim" & DGP=="noSDID1")$`2018`))))
  print(paste0("PT-DID avg CI length: ", 1.96*2*mean(subset(result_pt, type=="se" & DGP=="noSDID1")$`2018`)))
  print(paste0("PT-DID avg CI length (DiM): ", 1.96*2*mean(subset(result_pt, type=="se_dim" & DGP=="noSDID1")$`2018`)))
  print(paste0("PT-DID coverage rate: ", mean(subset(result_pt, type=="coverage" & DGP=="noSDID1")$`2018`)))
  print(paste0("PT-DID coverage rate: ", mean(subset(result_pt, type=="coverage_dim" & DGP=="noSDID1")$`2018`)))
  print(paste0("PT-DID avg time: ", mean(subset(result_pt, type=="time" & DGP=="noSDID1")$`2018`)))
  print(paste0("-"))
  print(paste0("SDID avg bias: ", mean(abs(true_tau-subset(result_sdid, type=="est" & DGP=="noSDID1")$`2018`))))
  print(paste0("SDID avg CI length: ", 1.96*2*mean(subset(result_sdid, type=="se" & DGP=="noSDID1")$`2018`)))
  print(paste0("SDID coverage rate: ", mean(subset(result_sdid, type=="coverage" & DGP=="noSDID1")$`2018`)))
  print(paste0("SDID avg time: ", mean(subset(result_sdid, type=="time" & DGP=="noSDID1")$`2018`)))
  print(paste0("-"))
  print(paste0("SC avg bias: ", mean(abs(true_tau-subset(result_sc, type=="est" & DGP=="noSDID1")$`2018`))))
  print(paste0("SC avg CI length: ", 1.96*2*mean(subset(result_sc, type=="se" & DGP=="noSDID1")$`2018`)))
  print(paste0("SC coverage rate: ", mean(subset(result_sc, type=="coverage" & DGP=="noSDID1")$`2018`)))
  print(paste0("SC avg time: ", mean(subset(result_sc, type=="time" & DGP=="noSDID1")$`2018`)))
  print(paste0("-"))
  print(paste0("SPT avg CS length: ", mean(subset(result_spt, type=="cs_ub" & DGP=="noSDID1")$`2018`-subset(result_spt, type=="cs_lb" & DGP=="noSDID1")$`2018`)))
  print(paste0("SPT coverage rate: ", mean(subset(result_spt, type=="coverage" & DGP=="noSDID1")$`2018`)))
  print(paste0("SPT avg time: ", mean(subset(result_spt, type=="time" & DGP=="noSDID1")$`2018`)))
  print(paste0("frac cand_tau rej: ", mean(frac_rej_noSDID)))
  
  print(end-start)
  
  write.csv(result_spt, "result_spt_SDID.csv", row.names=FALSE)
  write.csv(result_pt, "result_pt_SDID.csv", row.names=FALSE)
  write.csv(result_sdid, "result_sdid_SDID.csv", row.names=FALSE)
}
