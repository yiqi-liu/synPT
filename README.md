...
```
This loop searches for an alternative weight that (i) preserves parallel pre-trends and (ii) produces a post-treatment violation of parallel trends at least twice the DID standard error.
