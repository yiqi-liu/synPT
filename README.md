...
All results will be directly printed in the RStudio console and also saved to the directory `result`. The results in Table 1 of the paper is run on a 2021 10-core, 16GB-RAM MacBook Pro under
```
